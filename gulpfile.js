...
.p-icon {
	background-image: url(${!argv.full ? "sprites.png" : "sprites-full.png"});
	display: block;
	width: 32px;
	height: 32px;
}
...
${spriteCSS}`;
	...
	const cssStream = spriteData.css
		.pipe(ifElse( argv.full && !argv.concat, cleanCSS ))
		.pipe(gulp.dest( !argv.full ? 'src/css' : 'www/' ));
